...
export const PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    features: [
      { icon: 'Maximize', label: 'Diện tích khuôn viên', value: '1,680 m²' },
      { icon: 'Bed', label: 'Phòng ngủ hoàng gia', value: '6 Suites' },
      { icon: 'Bath', label: 'Phòng tắm Jacuzzi', value: '7 Phòng' },
      { icon: 'Compass', label: 'Hướng phong thủy', value: 'Đông Nam - Vượng khí' }
    ],
    amenities: [
      { name: 'Trung tâm lặn biển Scuba Diving', description: 'Trang thiết bị lặn chuyên nghiệp có hướng dẫn viên riêng' },
      { name: 'Hầm xì gà biển sâu', description: 'Kiểm soát nhiệt ẩm điện tử chuẩn Thụy Sĩ' }
    ],
    floorPlans: [
      { name: 'Tầng Trệt - Ocean Lounge & Pool Deck', area: '500 m²', image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&q=80&w=800', bedrooms: 2, bathrooms: 2 },
      { name: 'Tầng 2 - Master Suites Panorama', area: '400 m²', image: 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&q=80&w=800', bedrooms: 4, bathrooms: 5 }
    ],
    architect: {
  ...
  },
  {
    ...
    features: [
      { icon: 'Maximize', label: 'Diện tích đất', value: '1,450 m²' },
      { icon: 'Home', label: 'Diện tích xây dựng', value: '2,100 m²' },
      { icon: 'Bed', label: 'Phòng ngủ tổng thống', value: '7 Phòng' },
      { icon: 'Compass', label: 'Hướng nhìn', value: 'Chính Tây - Hoàng hôn sông' }
    ],
    amenities: [
      { name: 'Cầu tàu du thuyền riêng', description: 'Có thể neo đậu du thuyền đến 80 feet an toàn' },
      { name: 'Phòng tiệc đại yến 40 khách', description: 'Bếp thương mại chuẩn Michelin phục vụ đầu bếp riêng' }
    ],
    floorPlans: [
      { name: 'Tầng Hầm - Gara siêu xe & Wine Cellar', area: '500 m²', image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&q=80&w=800', bedrooms: 1, bathrooms: 1 },
      { name: 'Tầng 1 - Đại sảnh Hoàng Gia & Phòng khách', area: '450 m²', image: 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&q=80&w=800', bedrooms: 1, bathrooms: 2 }
    ],
    architect: {
  ...
  },
  {
    ...
    features: [
      { icon: 'Maximize', label: 'Diện tích sử dụng', value: '540 m²' },
      { icon: 'Bed', label: 'Phòng ngủ tổng thống', value: '4 Phòng' },
      { icon: 'Compass', label: 'Hướng view', value: 'Tây Bắc - Trực diện Hồ Tây' },
      { icon: 'ShieldCheck', label: 'Bảo mật', value: 'Lớp an ninh 4 vòng 24/7' }
    ],
    amenities: [
      { name: 'Khu vực thưởng trà thượng hạng', description: 'Bộ bàn trà gỗ Mun hoa và đồ gốm sứ nghệ thuật cổ' },
      { name: 'Phòng chiếu phim 4K HDR', description: 'Hệ thống âm thanh Bowers & Wilkins cao cấp' }
    ],
    floorPlans: [
      { name: 'Tầng 35 - Không gian sinh hoạt & Sky Lounge', area: '290 m²', image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&q=80&w=800', bedrooms: 1, bathrooms: 2 },
      { name: 'Tầng 36 - Master Suite & Ban công kính', area: '250 m²', image: 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&q=80&w=800', bedrooms: 3, bathrooms: 3 }
    ],
    architect: {
  ...
  },
  {
    ...
    features: [
      { icon: 'Maximize', label: 'Diện tích', value: '490 m²' },
      { icon: 'Bed', label: 'Phòng ngủ hướng biển', value: '4 Phòng' },
      { icon: 'Compass', label: 'Hướng nhìn', value: 'Đông - Trực diện bình minh' }
    ],
    amenities: [
      { name: 'Sân bay trực thăng', description: 'Đặc quyền sử dụng bãi đáp trực thăng tại đỉnh tháp' },
      { name: 'Dịch vụ đầu bếp riêng tư', description: 'Phục vụ các món hải sản thượng hạng tận phòng' }
    ],
    floorPlans: [
      { name: 'Tầng 1 - Phòng khách & Bếp đảo', area: '260 m²', image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&q=80&w=800', bedrooms: 1, bathrooms: 2 },
      { name: 'Tầng 2 - Phòng ngủ Master & Bể bơi', area: '230 m²', image: 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&q=80&w=800', bedrooms: 3, bathrooms: 2 }
    ],
    architect: {
  ...
  },
  {
    ...
    features: [
      { icon: 'Maximize', label: 'Diện tích', value: '510 m²' },
      { icon: 'Bed', label: 'Phòng ngủ cao cấp', value: '4 Phòng' },
      { icon: 'Compass', label: 'Hướng nhìn', value: 'Đông Nam - Đón gió sông' }
    ],
    amenities: [
      { name: 'Khu xông hơi khô tuyết lạnh Cryo', description: 'Trải nghiệm hồi phục thể lực chuẩn vận động viên Olympic' },
      { name: 'Quầy Cocktail Bar nghệ thuật', description: 'Trang bị máy pha rượu tự động tích hợp AI' }
    ],
    floorPlans: [
      { name: 'Tầng 1 - Phòng khách lớn & Bếp mở', area: '270 m²', image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&q=80&w=800', bedrooms: 2, bathrooms: 2 },
      { name: 'Tầng 2 - Phòng ngủ Master & Spa tại gia', area: '240 m²', image: 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&q=80&w=800', bedrooms: 2, bathrooms: 3 }
    ],
    architect: {
  ...
  },
  {
    ...
    features: [
      { icon: 'Maximize', label: 'Diện tích', value: '460 m²' },
      { icon: 'Bed', label: 'Phòng ngủ View Vịnh', value: '4 Phòng' },
      { icon: 'Compass', label: 'Hướng nhìn', value: 'Nam - View trọn vịnh di sản' }
    ],
    amenities: [
      { name: 'Du thuyền thưởng ngoạn riêng', description: 'Đặc quyền 30 ngày du ngoạn vịnh mỗi năm trên du thuyền 5 sao' },
      { name: 'Hồ bơi 4 mùa sưởi nhiệt', description: 'Nhiệt độ nước duy trì 32°C lý tưởng cả mùa đông' }
    ],
    floorPlans: [
      { name: 'Tầng 1 - Khu tiếp khách & Terrace', area: '250 m²', image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&q=80&w=800', bedrooms: 1, bathrooms: 2 },
      { name: 'Tầng 2 - Phòng ngủ Suites', area: '210 m²', image: 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&q=80&w=800', bedrooms: 3, bathrooms: 2 }
    ],
    architect: {
  ...
  },
  {
    ...
    features: [
      { icon: 'Maximize', label: 'Diện tích đất', value: '2,800 m²' },
      { icon: 'Bed', label: 'Phòng ngủ ấm cúng', value: '5 Phòng' },
      { icon: 'Flame', label: 'Hệ thống sưởi', value: 'Sưởi sàn Thụy Sĩ' },
      { icon: 'Compass', label: 'Hướng nhìn', value: 'Mặt nước hồ Tuyền Lâm' }
    ],
    amenities: [
      { name: 'Khu lều Glamping sang trọng', description: 'Không gian cắm trại ngắm dải ngân hà đêm' },
      { name: 'Hầm rượu vang sườn đồi', description: 'Được xây âm trong lòng đất duy trì nhiệt độ 14°C' }
    ],
    floorPlans: [
      { name: 'Tầng 1 - Phòng khách lớn & Sảnh tiệc sưởi', area: '320 m²', image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&q=80&w=800', bedrooms: 2, bathrooms: 2 },
      { name: 'Tầng 2 - Master Suites ngắm hồ', area: '260 m²', image: 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&q=80&w=800', bedrooms: 3, bathrooms: 4 }
    ],
    architect: {
  ...
  },
  {
    ...
    features: [
      { icon: 'Maximize', label: 'Diện tích khuôn viên', value: '1,900 m²' },
      { icon: 'Bed', label: 'Phòng ngủ ấm áp', value: '4 Phòng' },
      { icon: 'Compass', label: 'Hướng nhìn', value: 'Đỉnh Lang Biang mây phủ' }
    ],
    amenities: [
      { name: 'Khu nướng BBQ sườn đồi', description: 'Trang bị bếp nướng củi than phong cách Âu' },
      { name: 'Vườn hoa cẩm tú cầu', description: 'Nở rộ quanh năm phủ kín khuôn viên' }
    ],
    floorPlans: [
      { name: 'Tầng 1 - Đại sảnh & Lò sưởi củi', area: '220 m²', image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&q=80&w=800', bedrooms: 1, bathrooms: 2 },
      { name: 'Tầng 2 - Phòng ngủ áp mái Chalet', area: '180 m²', image: 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&q=80&w=800', bedrooms: 3, bathrooms: 3 }
    ],
    architect: {
  ...
  },
  {
    ...
    features: [
      { icon: 'Maximize', label: 'Diện tích', value: '430 m²' },
      { icon: 'Bed', label: 'Phòng ngủ Gallery', value: '3 Suites' },
      { icon: 'ShieldCheck', label: 'Bảo tàng tư nhân', value: 'Hệ thống bảo quản độ ẩm 55%' }
    ],
    amenities: [
      { name: 'Phòng nếm rượu & Thưởng tranh', description: 'Được thiết kế riêng cho những buổi gặp gỡ giới sưu tập tinh hoa' },
      { name: 'Thang máy độc quyền', description: 'Di chuyển thẳng vào sảnh căn hộ không tiếp xúc' }
    ],
    floorPlans: [
      { name: 'Mặt bằng tổng thể - Art Gallery & Master Suites', area: '430 m²', image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&q=80&w=800', bedrooms: 3, bathrooms: 4 }
    ],
    architect: {
  ...
  },
  {
    ...
    features: [
      { icon: 'Maximize', label: 'Diện tích đất', value: '920 m²' },
      { icon: 'Bed', label: 'Phòng ngủ Di sản', value: '5 Phòng' },
      { icon: 'Compass', label: 'Hướng phong thủy', value: 'Đông Nam - Đón vượng khí' }
    ],
    amenities: [
      { name: 'Khu thưởng trà đạo Hội An', description: 'Bộ bàn ghế chạm khảm ốc xà cừ cổ vật quý giá' },
      { name: 'Bến thả đèn hoa đăng', description: 'Cầu gỗ tư nhân bước thẳng ra dòng sông Hoài' }
    ],
    floorPlans: [
      { name: 'Tầng 1 - Sân trong giếng trời & Bếp xưa', area: '380 m²', image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&q=80&w=800', bedrooms: 2, bathrooms: 2 },
      { name: 'Tầng 2 - Phòng ngủ Master & Ban công ngắm phố', area: '300 m²', image: 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&q=80&w=800', bedrooms: 3, bathrooms: 4 }
    ],
    architect: {
  ...
  },
  {
    ...
    features: [
      { icon: 'Maximize', label: 'Diện tích', value: '3,500 m²' },
      { icon: 'Bed', label: 'Phòng ngủ sinh thái', value: '5 Phòng' },
      { icon: 'Leaf', label: 'Chứng chỉ Net Zero', value: 'Chứng nhận Quốc Tế' }
    ],
    amenities: [
      { name: 'Đài quan sát thiên văn', description: 'Trang bị kính thiên văn quang học cao cấp' },
      { name: 'Khu bảo tồn lan rừng', description: 'Nơi quy tụ hơn 50 loài lan rừng quý hiếm' }
    ],
    floorPlans: [
      { name: 'Mặt bằng tổng thể khu nghỉ dưỡng sinh thái', area: '680 m²', image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&q=80&w=800', bedrooms: 5, bathrooms: 6 }
    ],
    architect: {
  ...
  },
  {
    ...
    features: [
      { icon: 'Maximize', label: 'Diện tích', value: '1,380 m²' },
      { icon: 'Bed', label: 'Phòng ngủ hướng biển', value: '6 Suites' },
      { icon: 'Compass', label: 'Hướng nhìn', value: 'Tây Nam - Hoàng hôn biển ngọc' }
    ],
    amenities: [
      { name: 'Quầy Bar ngắm hoàng hôn Sunset Lounge', description: 'Nằm nhô ra mặt biển phục vụ cocktail cao cấp' },
      { name: 'Phòng trị liệu Spa đôi', description: 'Liệu trình thư giãn dầu dừa và ngọc trai Phú Quốc' }
    ],
    floorPlans: [
      { name: 'Tầng 1 - Beach Lounge & Sân hồ bơi', area: '420 m²', image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&q=80&w=800', bedrooms: 2, bathrooms: 2 },
      { name: 'Tầng 2 & 3 - Master Suites & Sky Terrace', area: '460 m²', image: 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&q=80&w=800', bedrooms: 4, bathrooms: 6 }
    ],
    architect: {
  ...
  },
  {
    ...
    features: [
      { icon: 'Maximize', label: 'Diện tích sàn', value: '720 m²' },
      { icon: 'Bed', label: 'Phòng ngủ Hoàng gia', value: '5 Suites' },
      { icon: 'Compass', label: 'Hướng nhìn', value: 'Đông Bắc - Sông Hồng & Sân Golf' }
    ],
    amenities: [
      { name: 'Sân tập Golf Putting Green trên cao', description: 'Cỏ nhân tạo tiêu chuẩn PGA Tour' },
      { name: 'Phòng dạ tiệc Khiêu vũ', description: 'Sàn gỗ sồi Pháp cách âm hoàn hảo' }
    ],
    floorPlans: [
      { name: 'Tầng 1 - Đại sảnh Versailles & Phòng dạ tiệc', area: '300 m²', image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&q=80&w=800', bedrooms: 1, bathrooms: 2 },
      { name: 'Tầng 2 & 3 - Phòng ngủ Hoàng gia & Sân vườn', area: '420 m²', image: 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&q=80&w=800', bedrooms: 4, bathrooms: 4 }
    ],
    architect: {
  ...
  },
  {
    ...
    features: [
      { icon: 'Maximize', label: 'Diện tích đất', value: '2,100 m²' },
      { icon: 'Bed', label: 'Phòng ngủ Oasis', value: '4 Phòng' },
      { icon: 'Leaf', label: 'Vật liệu', value: 'Đất nện hữu cơ & Gỗ tự nhiên' }
    ],
    amenities: [
      { name: 'Khu Yoga thiền định trên đồi cát', description: 'Nơi đón ánh bình minh đầu tiên của ngày mới' },
      { name: 'Rạp chiếu phim ngoài trời', description: 'Thưởng thức điện ảnh dưới bầu trời ngàn sao' }
    ],
    floorPlans: [
      { name: 'Mặt bằng tầng 1 & 2 - Khu Oasis Living', area: '480 m²', image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&q=80&w=800', bedrooms: 4, bathrooms: 5 }
    ],
    architect: {
...
// Re-export CATEGORIES and LOCATIONS for backwards-compatibility
export { CATEGORIES, PURE_CATEGORIES } from './categories';
export { LOCATIONS, CITIES } from './locations';
